    ...
    <x-slot name="header">
        <nav class="font-semibold text-xl text-gray-800 leading-tight" aria-label="Breadcrumb">
            <ol class="list-none p-0 inline-flex">
              ...
              <li>
                <a href="#" class="text-gray-500" aria-current="page">Crear medicamento</a>
              </li>
            </ol>
          </nav>
    </x-slot>
                        ...
                        <form method="POST" action="{{ route('medicamentos.store') }}">
                            ...
                            <div>
                                ...
                                <div>
                                    ...
                                    <x-input id="miligramos" class="block mt-1 w-full" type="number" name="miligramos" step="5" :value="old('miligramos')" required autofocus />
                                </div>
