<x-app-layout>
    ...
    <form class="ml-4" method="GET" action="{{ route('medicamentos.index') }}">


                    <form class="ml-auto mr-2" method="GET" action="{{ route('medicamentos.index') }}">
                        ...
                        <tbody class="text-gray-600 text-sm font-light">
                            @foreach ($medicamentos as $medicamento)
                                <tr class="border-b border-gray-200 hover:bg-gray-100">
                                    <td class="py-3 px-6 text-left whitespace-nowrap" colspan="2">
                                        <div class="flex items-center">
                                    ...
                                    <td class="py-3 px-6 text-left whitespace-nowrap" colspan="2">
                                        <div class="flex items-center">
                                            <span class="font-medium">{{$medicamento->miligramos}}</span>
                                        </div>
                                    </td>
