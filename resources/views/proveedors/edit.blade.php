    ...
    <x-slot name="header">
        <nav class="font-semibold text-xl text-gray-800 leading-tight" aria-label="Breadcrumb">
            <ol class="list-none p-0 inline-flex">
              ...
              <li>
                <a href="#" class="text-gray-500" aria-current="page">Editar {{$proveedor->nombre}} {{$proveedor->email}} {{$proveedor->telefono}} {{$proveedor->direccion}} {{$proveedor->medicamento->nombre}} </a>
              </li>
            </ol>
          </nav>
    </x-slot>
                ...
                <div class="p-6 bg-white border-b border-gray-200">
                        ...
                        <form method="POST" action="{{ route('proveedors.update', $proveedor->id) }}">
                            ...
                            <x-select id="medicamento_id" name="medicamento_id" required>
                                    ...
                                    <option value="{{$medicamento->id}}" @if ($proveedor->medicamento_id == $medicamento->id) selected @endif>{{$medicamento->nombre}}</option>
                                    @endforeach
                                </x-select>
                        </div>
